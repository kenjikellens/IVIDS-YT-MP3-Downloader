...
def ask_ai(filename, folder_name, tags):
    """
    Vraagt metadata aan Gemini met API Key 1 (Pro Key) via een opeenvolgende fallback-lijst van 6 modellen.
    ...
    def try_model(model_name):
        ...
        """
        logger.info(f"[Gemini 1] Proberen met model: {model_name}")
        try:
